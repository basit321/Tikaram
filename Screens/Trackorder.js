...
<Text style={{fontFamily:'arabicRegular',fontSize:14,color:"#007BFF"}}>
 ...
 Ahmad Ben Taymeyah Street
        ...
        <Box style={{height:171,width:width*0.9,borderRadius:15,borderColor:'#fff'}} bgColor='white' borderWidth='1'  
         shadow='2' mt='5%'
        ...
        >  
            ...
            <View  style={{flex:1,borderBottomWidth:1,borderColor:"#E1E1E1"}}>
               <HStack width='90%' mx='auto' mt='2%' justifyContent='space-between'>
                <VStack>
...
Description
        ...
        >  
            ...
            <View  style={{flex:1,borderBottomWidth:1,borderColor:"#E1E1E1"}}>
            <VStack width='90%' mx='auto' mt='10%' space='20%'>
        ...
        <Text style={{fontFamily:'arabicRegular',fontSize:16,color:"#00A27F", marginTop:"-5%",}}>
         2.30JD 
                ...
                <HStack justifyContent='space-between'>
                <Text style={{fontFamily:'arabicRegular',fontSize:16,color:"#374151", marginTop:"3%",}}>
         Tax
        </Text>
        <Text style={{fontFamily:'arabicRegular',fontSize:16,color:"#00A27F", marginTop:"3%",}}>
         2.30JD 
        </Text> 
                </HStack>
                </VStack>
