...
import { Airline , Airline1,Final } from '../Components/Cards'
                    ...
                    <View style={{backgroundColor:"#F6F6F6",flex:1}}>
                       ...
                       <TouchableOpacity activeOpacity={1} onPress={()=>navigation.navigate('Dashboard')}>
                          ...
                          > 
                            ...
                            <AeroPlane style={{marginLeft:"auto",marginRight:"auto"}}/>
                           
                <Text style={{fontFamily:'arabicMedium',fontSize:18,color:"#fff", marginTop:"2%",marginLeft:"2%"}}>
                The reservation has been made and the ticket has been sent to the phone number
        </Text> 
