...
const Flying_ticket = ({navigation}) => {
...
<VStack  style={{width:width*0.9}}   mx='auto' mt='5%' paddingBottom='5%' >
         <TouchableOpacity activeOpacity={1} onPress={()=>navigation.navigate('Flyingcheckin')}>     
               <VStack  >
               ...
               <TouchableOpacity activeOpacity={1} onPress={()=>navigation.navigate('Flyingcart')}>     
               <VStack  >
               ...
               <TouchableOpacity activeOpacity={1} onPress={()=>navigation.navigate('Fromcity')}> 
            <VStack  >
              ...
              <TouchableOpacity activeOpacity={1} onPress={()=>navigation.navigate('To_country')}>     
               <VStack  >
               ...
               <TouchableOpacity activeOpacity={1} onPress={()=>navigation.navigate('To_city')}> 
            <VStack  >
              ...
              <VStack  >
              <TouchableOpacity activeOpacity={1} onPress={()=>navigation.navigate('Degree')}>   
              <VStack  >
