...
<Text style={{fontFamily:'arabicBold',fontSize:18,color:"black",marginLeft:"5%",}}>
 ...
 <VStack mt='5%' space='2%'>
<TouchableOpacity activeOpacity={1} onPress={()=>setcity(true)}>
...
<Modal isVisible={City} style={styles.slidemodel}
          ...
          avoidKeyboard={false}
          onBackButtonPress=  { () =>setcity(false)}
        >
           <View style={{
...
borderColor: 'rgba(0, 0, 0, 0.1)',
   ...
   <Header containerStyle={{  borderWidth:0 ,
    ...
    leftComponent={
 <TouchableOpacity activeOpacity={1} onPress={()=>setcity(false)} >
           <Ionicons name="ios-arrow-back-sharp" size={24} color="#fff" /> 
           </TouchableOpacity>
...
<Text style={{fontFamily:'arabicBold',fontSize:18,color:"black",marginLeft:"5%",}}>
 ...
 <VStack mt='5%' space='2%'>
<TouchableOpacity activeOpacity={1} onPress={()=>setTocountry(true)}>
<Box style={{height:54,width:width*0.9,borderRadius:15}} bgColor='white' borderWidth='1'  
borderColor='gray.50' shadow='2'
...
Jerash
        ...
        <Modal isVisible={Tocountry} style={styles.slidemodel}
           animationIn={'slideInRight'}
           animationOut={'slideOutRight'}
          backdropTransitionOutTiming={1000}
          animationInTiming={500}
          animationOutTiming={500}
          avoidKeyboard={false}
          onBackButtonPress=  { () =>setTocountry(false)}
        >
           <View style={{
...
borderColor: 'rgba(0, 0, 0, 0.1)',
   ...
   <Header containerStyle={{  borderWidth:0 ,
    ...
    leftComponent={
 <TouchableOpacity activeOpacity={1} onPress={()=>setTocountry(false)} >
           <Ionicons name="ios-arrow-back-sharp" size={24} color="#fff" /> 
           </TouchableOpacity>
