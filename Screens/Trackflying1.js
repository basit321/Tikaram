...
import { Airline , Airline1 } from '../Components/Cards'
    ...
    <ScrollView style={{
        ...
        Flyingtickets
                    ...
                    <View style={{backgroundColor:"#F6F6F6",flex:1}}>
                       <VStack mt='5%' mx='auto'>
                       <TouchableOpacity activeOpacity={1} onPress={()=>navigation.navigate('Trackflying2')}>
                          <ImageBackground
