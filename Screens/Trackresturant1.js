...
const Trackresturant1 = ({navigation}) => {
      ...
      borderColor: 'rgba(0, 0, 0, 0.1)',
       ...
       Resturant Order
                  ...
                  <View style={{backgroundColor:"#F6F6F6",flex:1}}>
                     <VStack mt='5%' mx='auto'>
                       <TouchableOpacity activeOpacity={1} onPress={()=>navigation.navigate('Trackrest1')}>
                        <ImageBackground
                       ...
                       > 
                         ...
                         <Image
                          source={require('../Images/Resturant2.png')}
...
export default Trackresturant1
